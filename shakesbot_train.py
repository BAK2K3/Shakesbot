...
training_file = os.path.isfile('shakesbot_train.h5')
testing_file = os.path.isfile('shakesbot_test.h5')
if training_file or testing_file:
    print("Shakesbot training or testing file already exists! Please move or delete this file, then try again")
    sys.exit(1)
else:
    pass
...
print("Shakesbot.txt located, and read successuly!")
...
#Confirmation
print('Please run shakesbot_test.py to test the model!')
sys.exit(0)
